...
```{r, out.width='100%'}
teachingApps::includeApp('location_scale', height = '800px')
```

## The Log-Location-Scale Family of Distributions

```{r, out.width='100%'}
teachingApps::includeApp('log_location_scale', height = '800px')
```
...
```{r, out.width='100%'}
teachingApps::includeApp('random_generator', height = '600px')
```
</div>
