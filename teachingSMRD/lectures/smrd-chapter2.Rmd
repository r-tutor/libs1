...
```{r out.width='100%'}
knitr::include_app(paste0(root_url,'probability_functions'), height = '800px')
```
...
```{r, out.width='100%'}
knitr::include_app(paste0(root_url,'figure2_1'), height = '800px')
```
...
```{r, out.width='100%'}
knitr::include_app(paste0(root_url,'censoring_types'), height = '250px')
```
...
```{r, out.width='100%'}
knitr::include_app(paste0(root_url,'figure2_5'), height = '600px')
```
...
```{r, out.width='100%'}
knitr::include_app(paste0(root_url,'censored_eventplots'), height = '600px')
```
...
```{r, out.width='100%'}
knitr::include_app(paste0(root_url,'data_patterns'), height = '600px')
```
...
```{r, out.width='100%'}
knitr::include_app(paste0(root_url,'likelihood_ace'), height = '600px')
```
...
```{r, out.width='100%'}
knitr::include_app(paste0(root_url,'likelihood_contributions'), height = '600px')
```
</div>
